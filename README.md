...
* ![Java](https://img.shields.io/badge/Java_11+-ED8B00?style=flat-square&logo=java&logoColor=white) - Ngôn ngữ lập trình chính 
* ![Java Swing](https://img.shields.io/badge/Java_Swing-4361EE?style=flat-square&logo=java&logoColor=white) - Thư viện xây dựng giao diện người dùng (GUI)
* ![N-Tier Architecture](https://img.shields.io/badge/N--Tier_Architecture-00A88C?style=flat-square) - Kiến trúc phân tầng dự án (common, business, model, view, controller)

**Database & Tools**
* ![Oracle](https://img.shields.io/badge/Oracle_DB-F80000?style=flat-square&logo=oracle&logoColor=white) - Hệ quản trị cơ sở dữ liệu 
* ![JDBC](https://img.shields.io/badge/JDBC-007396?style=flat-square&logo=java&logoColor=white) - Công cụ kết nối và truy cập dữ liệu
* ![NetBeans](https://img.shields.io/badge/NetBeans-1B6AC6?style=flat-square&logo=apache-netbeans&logoColor=white) - IDE phát triển chính
* ![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white) - Quản lý mã nguồn và làm việc nhóm

**Third-party Services**
* ![Apache POI](https://img.shields.io/badge/Apache_POI-D22128?style=flat-square&logo=apache&logoColor=white) - Xử lý và xuất báo cáo file Excel (.xlsx)
* ![iText 7](https://img.shields.io/badge/iText_7-293649?style=flat-square) - Công cụ xuất báo cáo/hóa đơn định dạng PDF (Unicode)
