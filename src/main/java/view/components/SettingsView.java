 ...
 * Cột trái: Hồ sơ cá nhân (40%). Cột phải: 3 Card cài đặt hệ thống (60%).
 * Sử dụng UIManager.getColor() để tương thích Light/Dark mode (FlatLaf).
 * Tất cả labels đều có emoji icon phía trước.
 *
 * @author Le Tan Vi
 */
public class SettingsView extends JPanel {
    ...
    private JPanel createProfilePanel() {
        ...
        lblPosition.setFont(new Font(FONT_FAMILY, Font.BOLD, 14));
        lblPosition.setForeground(getThemeSecondaryTextColor());
     ...
     * Sử dụng Graphics2D để vẽ hình tròn accent color.
     *
    ...
    private ImageIcon createDefaultAvatarIcon(int size) {
        ...
        // Vẽ hình tròn nền - sử dụng màu accent từ UIManager
        Color avatarBg = getThemeAccentColor();
    ...
    /**
     * Tạo Card "Giao diện & Hiển thị" với emoji icons,
     * JComboBox cho theme và kích cỡ chữ, MatteBorder.
     */
    ...
    /**
     * Tạo Card "Thông báo & Bảo mật" với emoji icons, các trường đổi Email/SĐT,
     * bật/tắt thông báo, và đổi mật khẩu. MatteBorder + TitledBorder.
     */
    private JPanel createNotificationSecurityCard() {
        JPanel card = createCardPanel("\uD83D\uDD10 Thông báo & Bảo mật");
     ...
     * Validate: kiểm tra rỗng và mật khẩu mới khớp xác nhận.
     */
    ...
    /**
     * Tạo Card "Lưu trữ & Hệ thống" với emoji icons,
     * các cài đặt lưu trữ và xóa cache. MatteBorder + TitledBorder.
     */
    private JPanel createStorageCard() {
        JPanel card = createCardPanel("\uD83D\uDCBE Lưu trữ & Hệ thống");
        ...
        // Dòng 2: 🗑️ Xóa bộ nhớ cache
        gbc.gridx = 0;
        gbc.gridy = 1;
        gbc.weightx = 0;
        gbc.fill = GridBagConstraints.NONE;
        card.add(new JLabel("\uD83D\uDDD1\uFE0F Cache:"), gbc);
        ...
        lblVersion.setForeground(getThemeSecondaryTextColor());
        gbc.gridx = 1;
        gbc.weightx = 1.0;
    ...
    // =========================================================================
    // CARD PANEL FACTORY - TẠO CARD VỚI MATTEBORDER + TITLEDBORDER
    // =========================================================================

    /**
     * Tạo JPanel Card chuẩn với MatteBorder mảnh (1px) và TitledBorder (14px bold).
     * Sử dụng UIManager.getColor() cho viền - KHÔNG hardcode màu.
     *
     * @param title Tiêu đề card (có emoji)
     * @return JPanel card đã cấu hình border và padding
     */
    ...
    // =========================================================================
    // HELPER METHODS - LẤY MÀU TỪ UIMANAGER (KHÔNG HARDCODE)
    // =========================================================================
    ...
    /**
     * Lấy màu accent từ UIManager, fallback sang xanh dương.
     */
    private Color getThemeAccentColor() {
        Color c = UIManager.getColor("Component.accentColor");
        return c != null ? c : new Color(41, 128, 185);
    }

    // =========================================================================
    // GETTERS / SETTERS CHO CÁC COMPONENT
    // =========================================================================

    /** Getter cho text field Số điện thoại */
    public JTextField getTxtPhone() { return txtPhone; }

    /** Getter cho text field Email */
    public JTextField getTxtEmail() { return txtEmail; }

    /** Getter cho combo box Theme */
    public JComboBox<String> getCboTheme() { return cboTheme; }

    /** Getter cho combo box Font Size */
    public JComboBox<String> getCboFontSize() { return cboFontSize; }

    /** Getter cho checkbox Thông báo */
    public JCheckBox getChkNotification() { return chkNotification; }

    /** Getter cho checkbox Auto Save */
    public JCheckBox getChkAutoSave() { return chkAutoSave; }

    /** Getter cho label Avatar */
    public JLabel getLblAvatar() { return lblAvatar; }

    /** Getter cho label Tên */
    public JLabel getLblName() { return lblName; }

    /** Getter cho label Chức vụ */
    public JLabel getLblPosition() { return lblPosition; }
}
